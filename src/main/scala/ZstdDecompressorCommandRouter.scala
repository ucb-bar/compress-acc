...
// val finished_src_info = Input(UInt(64.W))
  ...
  val MAX_OFFSET_ALLOWED = UInt(OUTPUT, 64.W)
  val ALGORITHM = UInt(OUTPUT, 1.W)
...
class ZstdDecompressorCommandRouter(val cmd_que_depth: Int)(implicit p: Parameters) 
  ...
  //ZSTD
  val FUNCT_ZSTD_SRC_INFO                 = 2.U //1
  val FUNCT_ZSTD_WKSP_INFO                = 3.U //2
  val FUNCT_ZSTD_DST_INFO                 = 4.U //3
  val FUNCT_ZSTD_CHECK_COMPLETION         = 5.U //4
  val FUNCT_ZSTD_MAX_OFFSET_ALLOWED       = 6.U //5
  //Snappy
  val FUNCT_SNAPPY_SRC_INFO               = 7.U //1
  val FUNCT_SNAPPY_DEST_INFO_AND_START    = 8.U //2
  val FUNCT_SNAPPY_CHECK_COMPLETION       = 9.U //3
  val FUNCT_SNAPPY_SET_ONCHIP_HIST        = 10.U //4
