...
class HufDecompressorMemwriter(val cmd_que_depth: Int, val write_cmp_flag:Boolean = true)
  ...
  val io = IO(new Bundle {
    ...
    val decompress_dest_info = Flipped((Decoupled(new DecompressDstInfo)))
  ...
  val decompress_dest_info_Q = Module(new Queue(new DecompressDstInfo, cmd_que_depth))
